...
public class EstadoRepositoryTest {
    ...
    public void deveCadastrarEstadoComDadosCompletos(){
        ...
        paisRepository.save(estado);

        Estado estadoNoBanco = paisRepository.findOneByIbge(estado.getIbge());
    ...
    public void naoDeveCadastrarEstadoComIbgeJaCadastrado(){
        ...
        Assertions.assertThrows( DataIntegrityViolationException.class, () -> paisRepository.save(estado2) );
