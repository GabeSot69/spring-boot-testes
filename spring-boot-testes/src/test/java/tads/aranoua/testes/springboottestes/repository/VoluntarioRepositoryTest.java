...
public class VoluntarioRepositoryTest {
    ...
    public void deveSalvarPessoaComDadosCompletos(){
        ...
        voluntarioRepository.save(pessoa);

        Pessoa pessoaNoBD = voluntarioRepository.findOneByCpf("11111111111");
...
//        Precondição 01: Pessoa com o CPF específico deve estar inserida no banco de dados.
        ...
        voluntarioRepository.save(pessoa1);
...
//      Início das ações do cenário:
        ...
        Assertions.assertThrows(DataIntegrityViolationException.class,
                () -> voluntarioRepository.save(pessoa2)
        );
